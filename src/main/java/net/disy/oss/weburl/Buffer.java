...
import static net.disy.oss.weburl.Util.checkOffsetAndCount;
import static net.disy.oss.weburl.Util.reverseBytesLong;
 ...
 */
final class Buffer implements Cloneable {
  ...
  public Buffer writeString(String string, int beginIndex, int endIndex, Charset charset) {
    ...
    if (charset == null) throw new IllegalArgumentException("charset == null");
    if (charset.equals(StandardCharsets.UTF_8)) return writeUtf8(string, beginIndex, endIndex);
   ...
   *
   * <p>Use {@link net.disy.oss.weburl.Buffer#readUnsafe} to create a cursor to read buffer data and {@link
   * net.disy.oss.weburl.Buffer#readAndWriteUnsafe} to create a cursor to read and write buffer data. In either case,
   ...
   * read-only operations like {@link net.disy.oss.weburl.Buffer#clone} are unsafe because they mark segments as shared.
   *
